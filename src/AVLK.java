class AVLK {
    ...
    private NodoAVLK InsertaenAVL(NodoAVLK a, int elemento) {
        if (a == null) {
            masAlto = true;
            return new NodoAVLK(elemento, null, null);
    ...
    //elimina al nodo y lo balancea para no perder el AVL
    private boolean masBajo;
    public void Eliminar(int elemento){
        laRaiz=EliminaenAVL(laRaiz, elemento);
        masBajo = false;
    }
    private NodoAVLK EliminaenAVL(NodoAVLK a, int elemento){
        if(elemento == a.elemento) {
            if(a.lchild == null && a.rchild == null){
                ...
                a.elemento = BuscaMayorIzq(a.lchild);
